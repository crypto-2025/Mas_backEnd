...
let web3Websocket = new Web3(new Web3.providers.WebsocketProvider(process.env.RPC_WS_URL));

const masContractAddress = process.env.MAS_CONTRACT_ADDRESS;
const fdusdContractAddress = process.env.FDUSD_CONTRACT_ADDRESS;
